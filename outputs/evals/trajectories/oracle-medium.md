# Trajectory: oracle / medium

- Score: `0.990`
- Path: `landing -> student_services -> forms_library -> tuition_billing_forms -> tuition_appeals_form`
...
graph TD
    ...
    node_forms_library -->|"Tuition and Billing Forms"| node_tuition_billing_forms:::pathEdge
    node_forms_library -->|"Financial Aid Forms"| node_financial_aid_forms
    node_forms_library -->|"Student Services"| node_student_services
    node_tuition_billing_forms["Tuition and Billing Forms"]
    class node_tuition_billing_forms visited
    node_tuition_billing_forms -->|"Tuition Appeals Form"| node_tuition_appeals_form:::pathEdge
    ...
    node_financial_aid_forms -->|"Paying for College"| node_paying_for_college
